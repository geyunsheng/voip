...
typedef enum {
    ERequestType_Init = 0,
    ERequestType_LandingCalls,//1
    ERequestType_VoiceCode,//2
    ERequestType_Group_CreateGroup,//3
    ERequestType_Group_ModifyGroup,//4
    ERequestType_Group_DeleteGroup,//5
    ERequestType_Group_QueryGroup,//6
    ERequestType_Group_GetPublicGroups,//7
    ERequestType_Group_SearchPublicGroups,//8
    ERequestType_Group_JoinGroup,//9
    ERequestType_Group_InviteJoinGroup,//10
    ERequestType_Group_DeleteGroupMember,//11
    ERequestType_Group_LogoutGroup,//12
    ERequestType_Member_AddMember,//13
    ERequestType_Member_ModifyMember,//14
    ERequestType_Member_DeleteMember,//15
    ERequestType_Member_QueryMember,//16
    ERequestType_Member_QueryGroup,//17
    ERequestType_Member_ForbidSpeak,//18
    ERequestType_Member_AskJoin,//19
    ERequestType_Member_InviteGroup,//20
    ERequestType_GrupCard_ModifyCard,//21
    ERequestType_GrupCard_QueryCard,//22
    ERequestType_GetServiceNum,//23
    ERequestType_GetCategoryList,//24
    ERequestType_GetExpertList,//25
    ERequestType_LockExpert,//26
//    ERequestType_GetDemoAccounts//27
} ERequestType;
...
@property (assign) ERequestType requestType;
