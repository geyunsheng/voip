...
#ifdef Demo_GDataXMLNODE_DEFINE_GLOBALS
#define _EXTERN
...
_EXTERN const char* kDemo_GDataXMLXPathDefaultNamespacePrefix _INITIALIZE_AS("_def_ns");
...
enum {
  Demo_GDataXMLInvalidKind = 0,
  Demo_GDataXMLDocumentKind,
  Demo_GDataXMLElementKind,
  Demo_GDataXMLAttributeKind,
  Demo_GDataXMLNamespaceKind,
  Demo_GDataXMLProcessingInstructionKind,
  Demo_GDataXMLCommentKind,
  Demo_GDataXMLTextKind,
  Demo_GDataXMLDTDKind,
  Demo_GDataXMLEntityDeclarationKind,
  Demo_GDataXMLAttributeDeclarationKind,
  Demo_GDataXMLElementDeclarationKind,
  Demo_GDataXMLNotationDeclarationKind
};

typedef NSUInteger Demo_GDataXMLNodeKind;

@interface Demo_GDataXMLNode : NSObject <NSCopying> {
@protected
...
+ (Demo_GDataXMLElement *)elementWithName:(NSString *)name URI:(NSString *)value;
...
@interface Demo_GDataXMLElement : Demo_GDataXMLNode
...
- (Demo_GDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
...
@interface Demo_GDataXMLDocument : NSObject {
@protected
